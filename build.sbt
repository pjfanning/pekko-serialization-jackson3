...
lazy val root = (project in file("."))
  .settings(
    ...
    licenses += ("Apache-2.0", new URL("https://github.com/pjfanning/pekko-serialization-jackson3/blob/main/LICENSE")),
    startYear := Some(2025),
    homepage := Some(url("https://github.com/pjfanning/pekko-serialization-jackson3")),
    ...
    scmInfo := Some(
      ScmInfo(
        browseUrl = url("https://github.com/pjfanning/pekko-serialization-jackson3.git"),
        connection = "scm:git:git@github.com:pjfanning/pekko-serialization-jackson3.git"
      )
    )
  )
