 ...
 */
@InternalApi private[jackson3] trait AddressModule extends SerializationModule {
 ...
 * INTERNAL API
 */
@InternalApi private[jackson3] object AddressSerializer {
 ...
 * INTERNAL API
 */
@InternalApi private[jackson3] class AddressSerializer extends StdScalarSerializer[Address](classOf[Address]) {
 ...
 * INTERNAL API
 */
@InternalApi private[jackson3] object AddressDeserializer {
 ...
 * INTERNAL API
 */
@InternalApi private[jackson3] class AddressDeserializer extends StdScalarDeserializer[Address](classOf[Address]) {
